    ...
    <div class="columns">
      <div class="two-thirds column centered">
        ...
        <form v-on:submit.prevent="subscribe">
          ...
          <button v-cloak class="btn" type="submit" v-bind:disabled="buttonDisable || emailInvalid" v-text="buttonText">
            Enable Push Messages
          </button>
          <button v-cloak v-if="isPushEnabled" class="btn btn-danger" type="button" v-on:click.prevent="unsubscribe"
                  v-bind:disabled="buttonDisableDisable"><span
            v-if="emailInvalid">Enter An Email To Unsubscribe</span><span v-else>Disable Push Messages</span></button>
        </form>
      </div>
    </div>
  </div>
...
<script>
  export default {
    ...
    created: function () {
      // TODO fetches credentials for firebase
